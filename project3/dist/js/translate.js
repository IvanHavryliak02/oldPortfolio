const translation = {
    ...
    "exp-subheader": {
        ...
        "PL": `Edukacja i Doświadczenie Zawodowe`
    },
    "educ": {
        "EN": `Education`,
        "PL": `Edukacja`
    ...
    "html-descr": {
        "EN": `HTML is not a programming language. It is structure of your website. It is necessary for basic layout of elements on your page.`,
        "PL": `HTML nie jest językiem programowania. To struktura twojej strony internetowej. Jest niezbędny do podstawowego układu elementów na stronie.`
    },
    "css-descr": {
        "EN": `CSS is a Cascading Style Sheet. This technology allows you to apply style properties to page elements, such as color, shape, size, layout, cursor hover effects, and much more.`,
        "PL": `CSS to kaskadowe tabele stylów. Ta technologia pozwala na stosowanie właściwości stylu do elementów strony, takich jak kolor, kształt, rozmiar, układ, efekty najechania kursora i wiele więcej.`
    },
    "js-descr": {
    ...
    "urway": {
        "EN": `In any way convenient for you:<br>`,
        "PL": `W dowolny sposób, który ci odpowiada:<br>`
    },
    "mymail": {
